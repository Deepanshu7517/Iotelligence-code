...
import { collaborators,clients,expertise } from "../../lib/data";
        ...
        <Section className="pt-24">
          <div className="grid items-center gap-12 lg:grid-cols-2">
            <div>
              ...
              >
                We deliver enterprise-grade AI and IIoT solutions enabling real-time intelligence, advanced analytics, traceability, and operational transparency, helping organizations achieve scalable efficiency, superior quality, and future-ready digital manufacturing transformation.``
              </motion.p>
